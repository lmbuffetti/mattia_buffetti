export const Projects = {
  "project":[
    ...
    },
    {
      ...
      "link":"http://999domande.triennale.org/",
    ...
    },
    {
      "ID":18,
      "title":"DailyWodz",
      "description":"<p>Find the most incredible and popular Workouts.<br><br>Daily WOD gives you a random WOD from our collection every day, of Benchmark WODs and Open workouts, to new and incredible workouts you have never done.<br><br>Don’t like our daily word suggestion ? No problem Simply click the “Try a different workout” button.<br><br>Daily WOD serves you a random WOD from our collection, ranging from classic benchmark WODs and competition workouts, to new, cool metcons.</p>",
      "tasks":"<p>I collaborate with Rui Pereira, founder and designer of the project, to develop the Website, realised using React, and the app for iOS and Android, using React Native and Expo. I used Firebase as database and I integrated sign up and sign in by mail and the social login.<br><br>I managed all process from creation until publishing on both platform, app store and play store.</p>",
      "skills":"<li>React Native</li><li>Redux</li><li>Expo</li><li>Firebase</li><li>Facebook App</li><li>Apple Login</li><li>Google API</li><li>Play Store</li><li>App Store Connect</li>",
      "link":"https://apps.apple.com/us/app/dailywodz/id1514456407",
      "linkAndroid":"https://play.google.com/store/apps/details?id=com.ruipereira.dailywod",
      "image":"dailywodz-app-luigi-mattia-buffetti-web-developer.jpg",
      "url":"dailywodz-app",
      "type":"app"
    },
  ]
